...
GENERATED_FOLDER = "COCO2017/sd_generated"
...
def main():
    ...
    batch_size = 16                  # Batch size per generation call
    ...
    #pipe = RectifiedFlowPipeline.from_pretrained(model_path,torch_dtype=torch.float32)
    pipe = pipe.to('cuda')
